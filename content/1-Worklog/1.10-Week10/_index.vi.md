...
| 4   | - Học về Amazon API Gateway <br>&emsp; + Tạo API resources <br>&emsp; + Tạo và tích hợp Lambda functions với API Gateway <br>&emsp; + Tạo methods và test invoke Lambda function | 11/12/2025 | 11/12/2025      | https://youtube.com/playlist?list=PL4NoNM0L1m71akbZ8uzEOupMULmMpR-s7&si=kSCnIDdngdWk4C6D |
| 5   | - Thực hành Input Validation trong API Gateway <br> - **Luyện tập:** <br>&emsp; + Tạo API Gateway models để validate request headers và body <br>&emsp; + Thêm mapping templates cho method request <br>&emsp; + Test logic validation bằng API Gateway console                      | 11/13/2025 | 11/13/2025      | https://youtube.com/playlist?list=PL4NoNM0L1m71akbZ8uzEOupMULmMpR-s7&si=kSCnIDdngdWk4C6D |
| 6   | - Sử dụng stage variables cho triển khai multi-environment <br> - **Luyện tập:** <br>&emsp; + Tạo Lambda function và versions <br>&emsp; + Tạo aliases và map chúng vào các stage khác nhau <br>&emsp; + Thêm stage variables và reference chúng trong Lambda integration <br>&emsp; + Test và verify triển khai thành công                                                                                   | 11/14/2025 | 11/14/2025      | https://youtube.com/playlist?list=PL4NoNM0L1m71akbZ8uzEOupMULmMpR-s7&si=kSCnIDdngdWk4C6D |
